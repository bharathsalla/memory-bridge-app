...
import memoCarelogo from '@/assets/memocare-logo.png';
        ...
        <motion.div
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
              ...
              className="w-32 h-32 rounded-[36px] overflow-hidden mb-8 shadow-lg">
                ...
                <img alt="MemoCare" className="w-full h-full object-cover rounded-none shadow-none" src="/lovable-uploads/e870b19c-fc1d-486f-815f-86f58cef95ed.png" />
              </motion.div>
