...
import {
  ...
  Plus, Eye, LogOut, BarChart3, Check, Settings2, Monitor, Mic, MousePointer, Timer, Scan, Clock, User, Sparkles, X } from
'lucide-react';
...
import {
  ...
  ChartLegendItem, ChartInsight, ActivityRing, chartColors } from
'@/components/ui/AppleHealthCharts';
...
export default function CaregiverDashboard() {
  ...
  if (activeCaregiverTab === 'vitals') {
    ...
    return (
      <div className="h-full overflow-y-auto ios-grouped-bg pb-6">
        {/* iOS Large Title Header — 24pt side margins */}
        <div className="pt-2 pb-1" style={{ paddingLeft: 24, paddingRight: 24 }}>
        ...
        <div className="mt-1 mb-0" style={{ paddingLeft: 24, paddingRight: 24 }}>
          
        </div>

        {/* Section Header — Crisis Forecast */}
        <div className="pt-0 pb-0" style={{ paddingLeft: 24, paddingRight: 24 }}>
        </div>
