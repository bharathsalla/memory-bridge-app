    ...
    return (
      <div className="h-full flex flex-col items-center justify-center px-8 bg-background">
        <div className="text-center mb-14">
          <div className="ios-card-elevated w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <motion.button whileTap={{ scale: 0.95 }} onClick={handleSOS}
          className="w-full py-12 rounded-3xl bg-destructive text-destructive-foreground flex flex-col items-center justify-center gap-4 sos-pulse">
      ...
      <div className="h-full overflow-y-auto bg-background pb-6">
        ...
        <div className="px-5 space-y-5">
          <div className="ios-card-elevated p-6 flex items-center gap-5 rounded-2xl">
            <div className="w-18 h-18 rounded-2xl bg-success/10 flex items-center justify-center shrink-0" style={{ width: 72, height: 72 }}>
          ...
          <div className="ios-card-elevated overflow-hidden rounded-2xl">
            ...
            <div className="px-5 pb-5">
              ...
              <div className="flex items-center gap-2.5 mt-3">
                ...
                <span className="px-4 py-1.5 rounded-full bg-success/10 text-success text-[16px] font-bold ml-auto">Safe zone</span>
              </div>
            </div>
          </div>

          <motion.button whileTap={{ scale: 0.97 }} onClick={handleSOS}
            className={`w-full p-8 rounded-2xl flex items-center justify-center gap-4 touch-target-xxl ${isSOSActive ? 'bg-destructive/10 border-2 border-destructive' : 'bg-destructive sos-pulse'}`}>
      ...
      <div className="px-5 space-y-4">
        ...
        <div className="ios-card-elevated overflow-hidden rounded-2xl">
          ...
          <div className="px-5 pb-5">
            ...
            <div className="flex items-center gap-2.5 mt-3">
              ...
              <span className="px-3 py-1.5 rounded-full bg-success/10 text-success text-[14px] font-bold ml-auto">Safe zone</span>
            </div>
          </div>
        </div>
        ...
        <div className="ios-card-elevated p-5 rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <span className="px-4 py-1.5 rounded-full bg-success/10 text-success text-[14px] font-bold">Active</span>
          </div>
        ...
        <div className="ios-card-elevated overflow-hidden rounded-2xl">
          ...
          {[
            ...
            <div key={contact.name} className="flex items-center gap-4 px-5 py-4 border-t border-border/30">
              ...
              <button className="w-14 h-14 rounded-xl bg-success/10 flex items-center justify-center touch-target" aria-label={`Call ${contact.name}`}>
        ...
        <motion.button whileTap={{ scale: 0.97 }} onClick={handleSOS}
          className="w-full p-6 rounded-2xl bg-destructive text-destructive-foreground flex items-center justify-center gap-3 sos-pulse touch-target-xl">
