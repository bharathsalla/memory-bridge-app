...
export default function SafetyScreen() {
  ...
  if (mode === 'essential') {
    return (
      <div className="h-full flex flex-col items-center justify-center px-8 bg-background lavender-shimmer">
        <div className="text-center mb-14">
          <div className="ios-card-elevated w-32 h-32 flex items-center justify-center mx-auto mb-6">
        ...
        <motion.button whileTap={{ scale: 0.95 }} onClick={handleSOS}
          className="w-full py-12 bg-destructive text-destructive-foreground flex flex-col items-center justify-center gap-4 sos-pulse">
        ...
        {(isSOSActive || sosCountdown !== null) && (
          <button onClick={() => { cancelSOS(); setSosCountdown(null); }} className="mt-8 text-[22px] text-muted-foreground touch-target-xxl font-bold">Cancel</button>
        )}
      </div>
    );
  }
  ...
  if (mode === 'simplified') {
    return (
      <div className="h-full overflow-y-auto bg-background rose-glow pb-6">
        ...
        <div className="px-5 space-y-5">
          <div className="ios-card-elevated p-6 flex items-center gap-5">
            <div className="bg-success/10 flex items-center justify-center shrink-0" style={{ width: 72, height: 72 }}>
          ...
          <div className="ios-card-elevated overflow-hidden">
            ...
            <div className="px-5 pb-5">
              ...
              <div className="flex items-center gap-2.5 mt-3">
                ...
                <span className="px-4 py-1.5 bg-success/10 text-success text-[16px] font-bold ml-auto">Safe zone</span>
              </div>
            </div>
          </div>

          <motion.button whileTap={{ scale: 0.97 }} onClick={handleSOS}
            className={`w-full p-8 flex items-center justify-center gap-4 touch-target-xxl ${isSOSActive ? 'bg-destructive/10 border-2 border-destructive' : 'bg-destructive sos-pulse'}`}>
    ...
    <div className="h-full overflow-y-auto bg-background warm-glow pb-6">
      ...
      <div className="px-5 space-y-4">
        <div className="ios-card-elevated p-5 flex items-center gap-4">
          <div className="w-14 h-14 bg-success/10 flex items-center justify-center shrink-0">
        ...
        <div className="ios-card-elevated overflow-hidden">
          ...
          <div className="px-5 pb-5">
            ...
            <div className="flex items-center gap-2.5 mt-3">
              ...
              <span className="px-3 py-1.5 bg-success/10 text-success text-[14px] font-bold ml-auto">Safe zone</span>
            </div>
          </div>
        </div>
        ...
        <div className="ios-card-elevated p-5">
          <div className="flex items-center gap-3">
            ...
            <span className="px-4 py-1.5 bg-success/10 text-success text-[14px] font-bold">Active</span>
          </div>
        ...
        <div className="ios-card-elevated overflow-hidden">
          ...
          {[
            ...
            <div key={contact.name} className="flex items-center gap-4 px-5 py-4 border-t border-border/30">
              <div className="w-14 h-14 bg-muted/60 flex items-center justify-center shrink-0">
              ...
              <button className="w-14 h-14 bg-success/10 flex items-center justify-center touch-target" aria-label={`Call ${contact.name}`}>
        ...
        <motion.button whileTap={{ scale: 0.97 }} onClick={handleSOS}
          className="w-full p-6 bg-destructive text-destructive-foreground flex items-center justify-center gap-3 sos-pulse touch-target-xl">
