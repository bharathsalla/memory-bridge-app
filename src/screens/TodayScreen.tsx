...
export default function TodayScreen() {
  ...
  return (
    <div className="h-full relative">
      ...
      <button className="absolute bottom-6 right-5 w-16 h-16 bg-primary text-primary-foreground flex items-center justify-center active:scale-90 transition-transform z-30 ios-card-elevated" aria-label="Voice input">
